...
El proyecto cubre las etapas basicas de obtencion de datos, preprocesamiento, seleccion de caracteristicas, entrenamiento de varios modelos y evaluacion con MSE y R2.
